[times, positions, velocities] = simulate2([1.988544e6 5.97219],[0 0 0; 0.983236 0 0]',[0 0 0; 0 0.0174939 0]',10);
...
earthPeriods = detectOrbitalPeriods(times, squeeze(positions(:,2,:)))